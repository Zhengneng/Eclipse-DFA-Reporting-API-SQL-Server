...
public class CreateStandardReport {
  ...
  public static Report insert(Dfareporting reporting, Long userProfileId, DimensionValue advertiser,
    ...
    report.setName(String.format("API Report: Advertiser %s %s", advertiser.getValue(),endDate));
    ...
    criteria.setDimensions(ImmutableList.of(
        ...
        new SortedDimension().setName("dfa:campaign"),
        new SortedDimension().setName("dfa:date"),
        new SortedDimension().setName("dfa:siteId"),
        new SortedDimension().setName("dfa:site"),
        new SortedDimension().setName("dfa:placementId"),
        new SortedDimension().setName("dfa:placement"),
        new SortedDimension().setName("dfa:creativeId"),
        new SortedDimension().setName("dfa:creative"),
        new SortedDimension().setName("dfa:creativeType"),
        new SortedDimension().setName("dfa:platformType"),
        new SortedDimension().setName("dfa:activityGroup"),
        new SortedDimension().setName("dfa:adType"),
        new SortedDimension().setName("dfa:placementCompatibility"),
        new SortedDimension().setName("dfa:mobileCarrier"),
        new SortedDimension().setName("dfa:contentCategory"),
        new SortedDimension().setName("dfa:dmaRegion")
        ));
